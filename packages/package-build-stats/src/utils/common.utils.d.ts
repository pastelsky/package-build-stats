...
export declare const getPackageJSONFromPath: ((filePath: string) => any) & memoize.Memoized<(filePath: string) => any>;
export declare function updateProjectPeerDependencies(projectPath: string, peerDependencies: {
    [key: string]: string;
}): Promise<void>;
/**
 * eg.
 ...
 */
export declare function cleanWebpackPath(filePath: string, installPath: string): string;
