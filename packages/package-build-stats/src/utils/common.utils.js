...
exports.isReactNativePackage = exports.cleanWebpackPath = exports.updateProjectPeerDependencies = exports.getPackageJSONFromPath = exports.getPackageFromWebpackPath = exports.parsePackageNameFromPath = exports.parsePackageString = exports.getExternals = exports.exec = void 0;
...
function getExternals(packageName, installPath) {
    ...
    // are externals
    const builtInExternals = builtin_modules_1.default.filter(mod => !dependencies.includes(mod) && mod !== packageName);
    return {
...
function getPackageFromWebpackPath(filePath) {
    let filePathReal = filePath.includes('!')
        ...
        : filePath;
    let lastNodeModulesIndex = filePathReal.lastIndexOf('node_modules') + 'node_modules'.length + 1;
    return {
        name: (0, exports.parsePackageNameFromPath)(filePathReal.substring(lastNodeModulesIndex)),
        cleanPath: filePathReal,
    };
}
exports.getPackageFromWebpackPath = getPackageFromWebpackPath;
exports.getPackageJSONFromPath = (0, memoizee_1.default)((filePath) => {
    const { cleanPath, name } = getPackageFromWebpackPath(filePath);
    const packageRoot = cleanPath.substring(0, cleanPath.lastIndexOf(name) + name.length);
    try {
...
async function updateProjectPeerDependencies(projectPath, peerDependencies) {
    ...
    const packageJSONContents = JSON.parse(await fs_1.default.promises.readFile(packageJSONPath, 'utf-8'));
    const updatedJSON = Object.assign(Object.assign({}, packageJSONContents), { targets: Object.assign(Object.assign({}, packageJSONContents.targets), { main: Object.assign(Object.assign({}, packageJSONContents.targets.main), { includeNodeModules: Object.fromEntries(Object.keys(peerDependencies).map(dep => [dep, false])) }) }), peerDependencies: Object.assign(Object.assign({}, packageJSONContents.peerDependencies), peerDependencies) });
    await fs_1.default.promises.writeFile(packageJSONPath, JSON.stringify(updatedJSON, null, 2), 'utf-8');
}
